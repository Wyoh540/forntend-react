...
import { type Options, loginAccessToken, getUsers, createUser, getUserMe, getItems, updateItem, createItem, getItemTags } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, infiniteQueryOptions, type InfiniteData } from '@tanstack/react-query';
import type { LoginAccessTokenData, LoginAccessTokenError, LoginAccessTokenResponse, GetUsersData, CreateUserData, CreateUserError, CreateUserResponse, GetUserMeData, GetItemsData, GetItemsError, GetItemsResponse, UpdateItemData, UpdateItemError, UpdateItemResponse, CreateItemData, CreateItemError, CreateItemResponse, GetItemTagsData } from '../types.gen';
